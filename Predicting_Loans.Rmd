...
### Analysis of income range description
...
```
Here we plot the distribution of the income ranges for the borrowers. We find that it does not necessarily follow a normal distribution, with the majority of the borrows have less than 75,000.
...
```
We find that california is the most popular state, followed by texas and new york. This makes sense since they are the biggest states.
...
```
A look at the probability of default by states. We find that **
